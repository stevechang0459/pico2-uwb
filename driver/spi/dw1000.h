...
enum dw1000_ds_twr_state
{
    DW1000_DS_TWR_STATE_RX_INIT = 0,
    DW1000_DS_TWR_STATE_TX_INIT = 1,
    DW1000_DS_TWR_STATE_BLINK,
    DW1000_DS_TWR_STATE_LISTEN,
    DW1000_DS_TWR_STATE_RANGING_INIT,
    DW1000_DS_TWR_STATE_INIT_WAIT,
    DW1000_DS_TWR_STATE_POLL,
    DW1000_DS_TWR_STATE_POLL_WAIT,
    DW1000_DS_TWR_STATE_RESPONSE,
    DW1000_DS_TWR_STATE_RESPONSE_WAIT,
    DW1000_DS_TWR_STATE_FINAL,
    DW1000_DS_TWR_STATE_FINAL_WAIT,
};
